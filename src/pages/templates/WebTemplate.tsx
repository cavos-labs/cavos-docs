  ...
  return (
    <DocLayout>
      <div className="doc-content">
        ...
        <p className="mb-4">
          The template demonstrates how to integrate the Aegis SDK with Next.js:
        </p>
...
await signOut();`}
        ...
        <p className="mb-4">
          The SDK is configured in the template with sensible defaults:
        </p>

        <CodeBlock
          language="typescript"
          filename="src/config/aegis.ts"
          code={`export const aegisConfig = {
  ...
  enableLogging: true,
        ...
        <div className="grid md:grid-cols-2 gap-6 my-6">
          <Card>
            ...
            <CardContent className="text-sm text-muted-foreground">
              <p>
                Uses <code>"use client"</code> directive for interactivity with
                Aegis SDK
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="text-sm text-muted-foreground">
              <p>Comprehensive error states and user feedback</p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="text-sm text-muted-foreground">
              <p>Visual feedback during authentication processes</p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="text-sm text-muted-foreground">
              <p>Client-side validation for improved user experience</p>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="space-y-4 my-6">
          <TerminalBlock command="npm run dev" />
          <TerminalBlock command="npm run build" />
          <TerminalBlock command="npm start" />
        </div>
